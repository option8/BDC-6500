; da65 V2.15
; Created:    2016-08-07 13:44:23
; Input file: /Users/option8/Dropbox/Projects/retro connector/GITHUB/BDC-6500/0000-0FFF-combined.rom
; Page:       1
...
; ----------------------------------------------------------------------------
Character ROM:
        .dbyt   $0000,$0000,$0004,$2000         ; F000 00 00 00 00 00 04 20 00  ...... .
        .dbyt   $2404,$0040,$8040,$8A0A         ; F008 24 04 00 40 80 40 8A 0A  $..@.@..
        .dbyt   $4A9F,$4A9F,$047E,$C52E         ; F010 4A 9F 4A 9F 04 7E C5 2E  J.J..~..
        .dbyt   $1401,$9148,$8402,$0D52         ; F018 14 01 91 48 84 02 0D 52  ...H...R
        .dbyt   $952C,$0A00,$4000,$2010         ; F020 95 2C 0A 00 40 00 20 10  .,..@. .
        .dbyt   $0448,$1030,$1004,$0281         ; F028 04 48 10 30 10 04 02 81  .H.0....
        .dbyt   $2101,$0024,$150E,$1500         ; F030 21 01 00 24 15 0E 15 00  !..$....
        .dbyt   $2404,$1F04,$8004,$0202         ; F038 24 04 1F 04 80 04 02 02  $.......
        .dbyt   $0000,$0000,$1F00,$0404         ; F040 00 00 00 00 1F 00 04 04  ........
        .dbyt   $0000,$0000,$1048,$0402         ; F048 00 00 00 00 10 48 04 02  .....H..
        .dbyt   $0C92,$9272,$120E,$6404         ; F050 0C 92 92 72 12 0E 64 04  ...r..d.
        .dbyt   $2404,$1F88,$4462,$810E         ; F058 24 04 1F 88 44 62 81 0E  $...Db..
        .dbyt   $9141,$6681,$0222,$9F12         ; F060 91 41 66 81 02 22 9F 12  .Af.."..
        .dbyt   $8A0E,$9101,$E1DE,$0E51         ; F068 8A 0E 91 01 E1 DE 0E 51  .......Q
        .dbyt   $113E,$9008,$0848,$E4C2         ; F070 11 3E 90 08 08 48 E4 C2  .>...H..
        .dbyt   $0E91,$516E,$910C,$8241         ; F078 0E 91 51 6E 91 0C 82 41  ..Qn...A
        .dbyt   $6F91,$0024,$0400,$0480         ; F080 6F 91 00 24 04 00 04 80  o..$....
        .dbyt   $2804,$2400,$0224,$0810         ; F088 28 04 24 00 02 24 08 10  (.$..$..
        .dbyt   $8800,$001F,$001F,$0824         ; F090 88 00 00 1F 00 1F 08 24  .......$
        .dbyt   $0241,$0204,$8044,$6482         ; F098 02 41 02 04 80 44 64 82  .A...Dd.
        .dbyt   $0E90,$5775,$9711,$9151         ; F0A0 0E 90 57 75 97 11 91 51  ..Wu...Q
        .dbyt   $7F91,$1E91,$51FE,$910E         ; F0A8 7F 91 1E 91 51 FE 91 0E  ....Q...
        .dbyt   $9150,$7090,$1C92,$91F1         ; F0B0 91 50 70 90 1C 92 91 F1  .Pp.....
        .dbyt   $111F,$9010,$FED0,$1090         ; F0B8 11 1F 90 10 FE D0 10 90  ........
        .dbyt   $10FE,$D00F,$9111,$73D0         ; F0C0 10 FE D0 0F 91 11 73 D0  ......s.
        .dbyt   $1191,$519F,$510E,$2404         ; F0C8 11 91 51 9F 51 0E 24 04  ..Q.Q.$.
        .dbyt   $6484,$0C12,$8262,$C211         ; F0D0 64 84 0C 12 82 62 C2 11  d....b..
        .dbyt   $9294,$9854,$1F90,$1090         ; F0D8 92 94 98 54 1F 90 10 90  ...T....
        .dbyt   $1011,$D1D1,$9555,$1191         ; F0E0 10 11 D1 D1 95 55 11 91  .....U..
        .dbyt   $5395,$590E,$9151,$7191         ; F0E8 53 95 59 0E 91 51 71 91  S.Y..Qq.
        .dbyt   $1090,$50FE,$910D,$9255         ; F0F0 10 90 50 FE 91 0D 92 55  ..P....U
        .dbyt   $7191,$1192,$54FE,$911E         ; F0F8 71 91 11 92 54 FE 91 1E  q...T...
        .dbyt   $8101,$6ED0,$0424,$04E4         ; F100 81 01 6E D0 04 24 04 E4  ..n..$..
        .dbyt   $C40E,$9151,$9151,$048A         ; F108 C4 0E 91 51 91 51 04 8A  ...Q.Q..
        .dbyt   $5191,$510A,$9555,$9551         ; F110 51 91 51 0A 95 55 95 51  Q.Q..U.Q
        .dbyt   $1191,$4A84,$4A04,$8444         ; F118 11 91 4A 84 4A 04 84 44  ..J.J..D
        .dbyt   $8A51,$1F10,$48E4,$C21C         ; F120 8A 51 1F 10 48 E4 C2 1C  .Q..H...
        .dbyt   $9010,$F010,$0081,$0204         ; F128 90 10 F0 10 00 81 02 04  ........
        .dbyt   $0807,$0141,$21C1,$0040         ; F130 08 07 01 41 21 C1 00 40  ...A!..@
        .dbyt   $8020,$111F,$0000,$0000         ; F138 80 20 11 1F 00 00 00 00  . ......
        .dbyt   $0040,$0080,$040F,$110F         ; F140 00 40 00 80 04 0F 11 0F  .@......
        .dbyt   $010E,$1E91,$119E,$100E         ; F148 01 0E 1E 91 11 9E 10 0E  ........
        .dbyt   $1010,$100E,$0F11,$510F         ; F150 10 10 10 0E 0F 11 51 0F  ......Q.
        .dbyt   $450C,$101E,$120C,$0848         ; F158 45 0C 10 1E 12 0C 08 48  E......H
        .dbyt   $883C,$088C,$620E,$1212         ; F160 88 3C 08 8C 62 0E 12 12  .<..b...
        .dbyt   $1292,$129C,$100E,$2404         ; F168 12 92 12 9C 10 0E 24 04  ......$.
        .dbyt   $0C00,$840A,$0202,$8212         ; F170 0C 00 84 0A 02 02 82 12  ........
        .dbyt   $9418,$9410,$0E24,$0464         ; F178 94 18 94 10 0E 24 04 64  .....$.d
        .dbyt   $0411,$1115,$150A,$1212         ; F180 04 11 11 15 15 0A 12 12  ........
        .dbyt   $1212,$0C0C,$1212,$120C         ; F188 12 12 0C 0C 12 12 12 0C  ........
        .dbyt   $90F0,$1C12,$1283,$628E         ; F190 90 F0 1C 12 12 83 62 8E  ......b.
        .dbyt   $1212,$1010,$1018,$160E         ; F198 12 12 10 10 10 18 16 0E  ........
        .dbyt   $010E,$100E,$0224,$0404         ; F1A0 01 0E 10 0E 02 24 04 04  .....$..
        .dbyt   $0E0F,$1212,$1212,$040A         ; F1A8 0E 0F 12 12 12 12 04 0A  ........
        .dbyt   $1111,$110A,$1515,$1111         ; F1B0 11 11 11 0A 15 15 11 11  ........
        .dbyt   $110A,$040A,$118C,$828E         ; F1B8 11 0A 04 0A 11 8C 82 8E  ........
        .dbyt   $1212,$1F08,$0402,$1F03         ; F1C0 12 12 1F 08 04 02 1F 03  ........
        .dbyt   $0484,$18C4,$0424,$0420         ; F1C8 04 84 18 C4 04 24 04 20  .....$. 
        .dbyt   $0418,$2404,$C304,$0000         ; F1D0 04 18 24 04 C3 04 00 00  ..$.....
        .dbyt   $0215,$0815,$4A95,$AA55         ; F1D8 02 15 08 15 4A 95 AA 55  ....J..U
        .dbyt   $A200                           ; F1E0 A2 00                    ..
; ----------------------------------------------------------------------------
LF1E2:  jsr     LF3A8                           ; F1E2 20 A8 F3                  ..
        beq     LF1F8                           ; F1E5 F0 11                    ..
        cmp     #$20                            ; F1E7 C9 20                    . 
        beq     LF1F8                           ; F1E9 F0 0D                    ..
        cmp     #$3D                            ; F1EB C9 3D                    .=
        beq     LF1F8                           ; F1ED F0 09                    ..
        sta     $BF51,x                         ; F1EF 9D 51 BF                 .Q.
        inx                                     ; F1F2 E8                       .
        iny                                     ; F1F3 C8                       .
        cpx     #$08                            ; F1F4 E0 08                    ..
        bne     LF1E2                           ; F1F6 D0 EA                    ..
LF1F8:  lda     #$00                            ; F1F8 A9 00                    ..
        sta     $BF51,x                         ; F1FA 9D 51 BF                 .Q.
        jsr     LF39D                           ; F1FD 20 9D F3                  ..
        rts                                     ; F200 60                       `
...
???:    .byte   $0B                             ; F201 0B                       .
        ...
        brk                                     ; F204 00                       .
        .byte   $0C                             ; F205 0C                       .
        bne     LF20B                           ; F206 D0 03                    ..
        jmp     LF306                           ; F208 4C 06 F3                 L..

; ----------------------------------------------------------------------------
LF20B:  cmp     #$52                            ; F20B C9 52                    .R
        bne     LF210                           ; F20D D0 01                    ..
        iny                                     ; F20F C8                       .
LF210:  jsr     LFA31                           ; F210 20 31 FA                  1.
        sta     $DD                             ; F213 85 DD                    ..
        lda     #$16                            ; F215 A9 16                    ..
        sta     $DE                             ; F217 85 DE                    ..
        jsr     LF39D                           ; F219 20 9D F3                  ..
        cmp     #$3D                            ; F21C C9 3D                    .=
        beq     LF223                           ; F21E F0 03                    ..
...
LF223:  iny                                     ; F223 C8                       .
        ...
        ldx     #$00                            ; F227 A2 00                    ..
        sta     ($DD,x)                         ; F229 81 DD                    ..
        jsr     LF39D                           ; F22B 20 9D F3                  ..
        bne     LF20B                           ; F22E D0 DB                    ..
        rts                                     ; F230 60                       `

; ----------------------------------------------------------------------------
        jsr     LFAF2                           ; F231 20 F2 FA                  ..
        jsr     LF39D                           ; F234 20 9D F3                  ..
        bne     LF241                           ; F237 D0 08                    ..
        ldx     #$DF                            ; F239 A2 DF                    ..
        jsr     LFBB0                           ; F23B 20 B0 FB                  ..
LF23E:  jmp     LF2A5                           ; F23E 4C A5 F2                 L..

; ----------------------------------------------------------------------------
LF241:  lda     ($E7),y                         ; F241 B1 E7                    ..
        cmp     #$3D                            ; F243 C9 3D                    .=
        beq     LF25D                           ; F245 F0 16                    ..
        jsr     LFAEE                           ; F247 20 EE FA                  ..
        jsr     LF39D                           ; F24A 20 9D F3                  ..
...
; ----------------------------------------------------------------------------
LF25D:  iny                                     ; F25D C8                       .
LF25E:  jsr     LF39D                           ; F25E 20 9D F3                  ..
        beq     LF2A4                           ; F261 F0 41                    .A
        cmp     #$54                            ; F263 C9 54                    .T
        bne     LF27F                           ; F265 D0 18                    ..
        jsr     LF39C                           ; F267 20 9C F3                  ..
        cmp     $1624                           ; F26A CD 24 16                 .$.
        bne     LF253                           ; F26D D0 E4                    ..
LF26F:  iny                                     ; F26F C8                       .
        lda     ($E7),y                         ; F270 B1 E7                    ..
        beq     LF2A4                           ; F272 F0 30                    .0
        cmp     $1624                           ; F274 CD 24 16                 .$.
        beq     LF25D                           ; F277 F0 E4                    ..
        jsr     LF29A                           ; F279 20 9A F2                  ..
        jmp     LF26F                           ; F27C 4C 6F F2                 Lo.

; ----------------------------------------------------------------------------
LF27F:  cmp     #$57                            ; F27F C9 57                    .W
        bne     LF294                           ; F281 D0 11                    ..
        iny                                     ; F283 C8                       .
        jsr     LFAEE                           ; F284 20 EE FA                  ..
        lda     $DF                             ; F287 A5 DF                    ..
        jsr     LF29A                           ; F289 20 9A F2                  ..
        lda     $E0                             ; F28C A5 E0                    ..
LF28E:  jsr     LF29A                           ; F28E 20 9A F2                  ..
        jmp     LF25E                           ; F291 4C 5E F2                 L^.

; ----------------------------------------------------------------------------
LF294:  jsr     LFAD7                           ; F294 20 D7 FA                  ..
        jmp     LF28E                           ; F297 4C 8E F2                 L..

; ----------------------------------------------------------------------------
LF29A:  ldx     #$00                            ; F29A A2 00                    ..
        sta     ($DD,x)                         ; F29C 81 DD                    ..
        inc     $DD                             ; F29E E6 DD                    ..
        bne     LF2A4                           ; F2A0 D0 02                    ..
        inc     $DE                             ; F2A2 E6 DE                    ..
LF2A4:  rts                                     ; F2A4 60                       `
...
LF2AD:  jsr     LF2EC                           ; F2AD 20 EC F2                  ..
        ldx     #$DD                            ; F2B0 A2 DD                    ..
        jsr     LF3E1                           ; F2B2 20 E1 F3                  ..
        ldx     #$10                            ; F2B5 A2 10                    ..
LF2B7:  jsr     LF2F7                           ; F2B7 20 F7 F2                  ..
        lda     ($DD),y                         ; F2BA B1 DD                    ..
        jsr     LF3EA                           ; F2BC 20 EA F3                  ..
        lda     $DD                             ; F2BF A5 DD                    ..
        cmp     $DF                             ; F2C1 C5 DF                    ..
        bne     LF2CF                           ; F2C3 D0 0A                    ..
        lda     $DE                             ; F2C5 A5 DE                    ..
        cmp     $E0                             ; F2C7 C5 E0                    ..
        bne     LF2CF                           ; F2C9 D0 04                    ..
        jsr     LF2F7                           ; F2CB 20 F7 F2                  ..
LF2CE:  rts                                     ; F2CE 60                       `

; ----------------------------------------------------------------------------
LF2CF:  inc     $DD                             ; F2CF E6 DD                    ..
        bne     LF2D5                           ; F2D1 D0 02                    ..
        inc     $DE                             ; F2D3 E6 DE                    ..
LF2D5:  dex                                     ; F2D5 CA                       .
        bne     LF2B7                           ; F2D6 D0 DF                    ..
        jsr     LF2FC                           ; F2D8 20 FC F2                  ..
        jsr     LF6A5                           ; F2DB 20 A5 F6                  ..
        jmp     LF2AD                           ; F2DE 4C AD F2                 L..
...
; ----------------------------------------------------------------------------
LF2EC:  lda     #$A7                            ; F2EC A9 A7                    ..
        sta     L00E9                           ; F2EE 85 E9                    ..
        lda     #$BF                            ; F2F0 A9 BF                    ..
        sta     $EA                             ; F2F2 85 EA                    ..
        ldy     #$00                            ; F2F4 A0 00                    ..
        rts                                     ; F2F6 60                       `
...
; ----------------------------------------------------------------------------
LF2F7:  lda     #$20                            ; F2F7 A9 20                    . 
        sta     (L00E9),y                       ; F2F9 91 E9                    ..
        iny                                     ; F2FB C8                       .
LF2FC:  lda     #$00                            ; F2FC A9 00                    ..
        sta     (L00E9),y                       ; F2FE 91 E9                    ..
...
LF306:  jsr     LF326                           ; F306 20 26 F3                  &.
        ldx     #$04                            ; F309 A2 04                    ..
LF30B:  lda     LF321,x                         ; F30B BD 21 F3                 .!.
        jsr     LF6AC                           ; F30E 20 AC F6                  ..
        jsr     LF2EC                           ; F311 20 EC F2                  ..
        lda     $1670,x                         ; F314 BD 70 16                 .p.
        jsr     LF3EA                           ; F317 20 EA F3                  ..
        jsr     LF2F7                           ; F31A 20 F7 F2                  ..
        dex                                     ; F31D CA                       .
        bpl     LF30B                           ; F31E 10 EB                    ..
        rts                                     ; F320 60                       `

; ----------------------------------------------------------------------------
LF321:  ror     $73                             ; F321 66 73                    fs
        adc     $6178,y                         ; F323 79 78 61                 yxa
...
LF392:  lda     #$00                            ; F392 A9 00                    ..
        ...
        dey                                     ; F39B 88                       .
LF39C:  iny                                     ; F39C C8                       .
LF39D:  jsr     LF3A8                           ; F39D 20 A8 F3                  ..
        beq     LF3A6                           ; F3A0 F0 04                    ..
        cmp     #$20                            ; F3A2 C9 20                    . 
        beq     LF39C                           ; F3A4 F0 F6                    ..
LF3A6:  rts                                     ; F3A6 60                       `

; ----------------------------------------------------------------------------
        iny                                     ; F3A7 C8                       .
LF3A8:  lda     ($E7),y                         ; F3A8 B1 E7                    ..
        beq     LF3B7                           ; F3AA F0 0B                    ..
...
; ----------------------------------------------------------------------------
        pha                                     ; F43C 48                       H
        lda     $1701                           ; F43D AD 01 17                 ...
        and     #$80                            ; F440 29 80                    ).
        sta     $1701                           ; F442 8D 01 17                 ...
        lda     $1700                           ; F445 AD 00 17                 ...
        ora     #$80                            ; F448 09 80                    ..
        cmp     #$83                            ; F44A C9 83                    ..
        bne     LF452                           ; F44C D0 04                    ..
        pla                                     ; F44E 68                       h
        jmp     (L1600)                         ; F44F 6C 00 16                 l..
...
LF46D:  stx     $BF4B                           ; F46D 8E 4B BF                 .K.
        sta     $BF4C                           ; F470 8D 4C BF                 .L.
...
LF4B7:  cmp     #$0C                            ; F4B7 C9 0C                    ..
        ...
        ldx     $BF4B                           ; F4BB AE 4B BF                 .K.
        ldy     $BF4C                           ; F4BE AC 4C BF                 .L.
        rts                                     ; F4C1 60                       `
...
; ----------------------------------------------------------------------------
LF4E0:  cmp     #$18                            ; F4E0 C9 18                    ..
        beq     LF4D0                           ; F4E2 F0 EC                    ..
        cmp     #$0D                            ; F4E4 C9 0D                    ..
        beq     LF4F1                           ; F4E6 F0 09                    ..
        sta     $C8E7,y                         ; F4E8 99 E7 C8                 ...
...
LF4F7:  jsr     LF6A5                           ; F4F7 20 A5 F6                  ..
        pla                                     ; F4FA 68                       h
        sta     L00E9                           ; F4FB 85 E9                    ..
        pla                                     ; F4FD 68                       h
        sta     $EA                             ; F4FE 85 EA                    ..
        inc     L00E9                           ; F500 E6 E9                    ..
...
LF506:  tya                                     ; F506 98                       .
        ...
        tya                                     ; F50B 98                       .
        clc                                     ; F50C 18                       .
        adc     L00E9                           ; F50D 65 E9                    e.
        sta     L00E9                           ; F50F 85 E9                    ..
        bcc     LF515                           ; F511 90 02                    ..
        inc     $EA                             ; F513 E6 EA                    ..
LF515:  pla                                     ; F515 68                       h
        tay                                     ; F516 A8                       .
        jmp     (L00E9)                         ; F517 6C E9 00                 l..

; ----------------------------------------------------------------------------
        jsr     LF6A5                           ; F51A 20 A5 F6                  ..
LF51D:  ldy     #$00                            ; F51D A0 00                    ..
        pha                                     ; F51F 48                       H
LF520:  lda     (L00E9),y                       ; F520 B1 E9                    ..
...
LF594:  sty     $962F                           ; F594 8C 2F 96                 ./.
        ...
        cpx     #$41                            ; F5A2 E0 41                    .A
        tya                                     ; F5A4 98                       .
        ora     $388A                           ; F5A5 0D 8A 38                 ..8
        sbc     #$40                            ; F5A8 E9 40                    .@
        sta     $162A                           ; F5AA 8D 2A 16                 .*.
        lda     #$FF                            ; F5AD A9 FF                    ..
        sec                                     ; F5AF 38                       8
        sbc     $162A                           ; F5B0 ED 2A 16                 .*.
        sta     $162A                           ; F5B3 8D 2A 16                 .*.
        ldx     #$00                            ; F5B6 A2 00                    ..
        stx     $EB                             ; F5B8 86 EB                    ..
        stx     $EC                             ; F5BA 86 EC                    ..
        rts                                     ; F5BC 60                       `
...
; ----------------------------------------------------------------------------
LF5BD:  jsr     LF65A                           ; F5BD 20 5A F6                  Z.
LF5C0:  bit     $1639                           ; F5C0 2C 39 16                 ,9.
...
; ----------------------------------------------------------------------------
        ...
        brk                                     ; F5D0 00                       .
        brk                                     ; F5D1 00                       .
LF5D2:  lda     $1734                           ; F5D2 AD 34 17                 .4.
        sta     $FB                             ; F5D5 85 FB                    ..
        clc                                     ; F5D7 18                       .
        adc     #$90                            ; F5D8 69 90                    i.
        sta     $F1                             ; F5DA 85 F1                    ..
...
LF607:  lda     ($F1),y                         ; F607 B1 F1                    ..
        ...
        ldx     $BF49                           ; F619 AE 49 BF                 .I.
        lda     $BF4A                           ; F61C AD 4A BF                 .J.
        rts                                     ; F61F 60                       `
...
LF620:  iny                                     ; F620 C8                       .
        ...
        inc     $FC                             ; F623 E6 FC                    ..
LF625:  sta     ($FB),y                         ; F625 91 FB                    ..
        dex                                     ; F627 CA                       .
        bne     LF620                           ; F628 D0 F6                    ..
        rts                                     ; F62A 60                       `

; ----------------------------------------------------------------------------
LF62B:  cmp     #$09                            ; F62B C9 09                    ..
        bne     LF69A                           ; F62D D0 6B                    .k
LF62F:  bit     $1639                           ; F62F 2C 39 16                 ,9.
...
LF647:  sec                                     ; F647 38                       8
        ...
        lda     $EE                             ; F64A A5 EE                    ..
        sbc     #$01                            ; F64C E9 01                    ..
        bcc     LF653                           ; F64E 90 03                    ..
        jmp     LF5BD                           ; F650 4C BD F5                 L..

; ----------------------------------------------------------------------------
LF653:  rts                                     ; F653 60                       `

; ----------------------------------------------------------------------------
LF654:  adc     #$20                            ; F654 69 20                    i 
        cmp     #$0D                            ; F656 C9 0D                    ..
        bne     LF677                           ; F658 D0 1D                    ..
LF65A:  lda     #$00                            ; F65A A9 00                    ..
...
; ----------------------------------------------------------------------------
LF669:  cmp     #$0A                            ; F669 C9 0A                    ..
        bne     LF670                           ; F66B D0 03                    ..
        jmp     LF5C0                           ; F66D 4C C0 F5                 L..

; ----------------------------------------------------------------------------
LF670:  cmp     #$18                            ; F670 C9 18                    ..
        bne     LF668                           ; F672 D0 F4                    ..
        jmp     LF5BD                           ; F674 4C BD F5                 L..

; ----------------------------------------------------------------------------
LF677:  cmp     #$08                            ; F677 C9 08                    ..
        bne     LF62B                           ; F679 D0 B0                    ..
        bit     $1639                           ; F67B 2C 39 16                 ,9.
        bmi     LF68A                           ; F67E 30 0A                    0.
        lda     $EB                             ; F680 A5 EB                    ..
        sec                                     ; F682 38                       8
        sbc     #$06                            ; F683 E9 06                    ..
        bcc     LF65A                           ; F685 90 D3                    ..
        sta     $EB                             ; F687 85 EB                    ..
        .byte   $E0                             ; F689 E0                       .
LF68A:  lda     $ED                             ; F68A A5 ED                    ..
        ...
        lda     $EE                             ; F691 A5 EE                    ..
        sbc     #$00                            ; F693 E9 00                    ..
        bcc     LF65A                           ; F695 90 C3                    ..
        sta     $EE                             ; F697 85 EE                    ..
        rts                                     ; F699 60                       `

; ----------------------------------------------------------------------------
LF69A:  cmp     #$0C                            ; F69A C9 0C                    ..
        bne     LF669                           ; F69C D0 CB                    ..
        jsr     LF956                           ; F69E 20 56 F9                  V.
        jsr     LF65A                           ; F6A1 20 5A F6                  Z.
        rts                                     ; F6A4 60                       `
...
LF6A5:  lda     #$0D                            ; F6A5 A9 0D                    ..
        ...
        lda     #$0A                            ; F6AA A9 0A                    ..
LF6AC:  .byte   $2C                             ; F6AC 2C                       ,
        rti                                     ; F6AD 40                       @

; ----------------------------------------------------------------------------
LF6AE:  asl     $50,x                           ; F6AE 16 50                    .P
        .byte   $03                             ; F6B0 03                       .
        jmp     (L1608)                         ; F6B1 6C 08 16                 l..

; ----------------------------------------------------------------------------
        stx     $BF49                           ; F6B4 8E 49 BF                 .I.
        sty     $BF4A                           ; F6B7 8C 4A BF                 .J.
        and     #$7F                            ; F6BA 29 7F                    ).
        sec                                     ; F6BC 38                       8
        sbc     #$20                            ; F6BD E9 20                    . 
        bcc     LF654                           ; F6BF 90 93                    ..
        sta     $F7                             ; F6C1 85 F7                    ..
        ...
        iny                                     ; F6D0 C8                       .
        clc                                     ; F6D1 18                       .
LF6D2:  adc     $F1                             ; F6D2 65 F1                    e.
        sta     $F1                             ; F6D4 85 F1                    ..
        bcc     LF6D9                           ; F6D6 90 01                    ..
        iny                                     ; F6D8 C8                       .
LF6D9:  sty     $F2                             ; F6D9 84 F2                    ..
        ldy     #$00                            ; F6DB A0 00                    ..
        sty     $FA                             ; F6DD 84 FA                    ..
        lda     ($F1),y                         ; F6DF B1 F1                    ..
        sta     $F4                             ; F6E1 85 F4                    ..
        bmi     LF6F1                           ; F6E3 30 0C                    0.
        sty     $F5                             ; F6E5 84 F5                    ..
        sty     $F6                             ; F6E7 84 F6                    ..
        jsr     LF715                           ; F6E9 20 15 F7                  ..
        jsr     LF715                           ; F6EC 20 15 F7                  ..
        sty     $FA                             ; F6EF 84 FA                    ..
LF6F1:  jsr     LF749                           ; F6F1 20 49 F7                  I.
        jsr     LF715                           ; F6F4 20 15 F7                  ..
        lda     $FA                             ; F6F7 A5 FA                    ..
        cmp     #$07                            ; F6F9 C9 07                    ..
        bmi     LF6F1                           ; F6FB 30 F4                    0.
        bit     $F4                             ; F6FD 24 F4                    $.
        bpl     LF70B                           ; F6FF 10 0A                    ..
        sty     $F5                             ; F701 84 F5                    ..
        sty     $F6                             ; F703 84 F6                    ..
        jsr     LF715                           ; F705 20 15 F7                  ..
        jsr     LF715                           ; F708 20 15 F7                  ..
LF70B:  jsr     LF62F                           ; F70B 20 2F F6                  /.
        ldy     $BF4A                           ; F70E AC 4A BF                 .J.
        ldx     $BF49                           ; F711 AE 49 BF                 .I.
        rts                                     ; F714 60                       `

; ----------------------------------------------------------------------------
LF715:  ldy     #$00                            ; F715 A0 00                    ..
        ldx     $FD                             ; F717 A6 FD                    ..
        lda     LF739,x                         ; F719 BD 39 F7                 .9.
        and     ($FB),y                         ; F71C 31 FB                    1.
        ora     $F5                             ; F71E 05 F5                    ..
        sta     ($FB),y                         ; F720 91 FB                    ..
        lda     LF741,x                         ; F722 BD 41 F7                 .A.
        iny                                     ; F725 C8                       .
        and     ($FB),y                         ; F726 31 FB                    1.
        ora     $F6                             ; F728 05 F6                    ..
        sta     ($FB),y                         ; F72A 91 FB                    ..
        lda     $FB                             ; F72C A5 FB                    ..
        sec                                     ; F72E 38                       8
...
; ----------------------------------------------------------------------------
LF739:  .byte   $03                             ; F739 03                       .
        sta     ($C0,x)                         ; F73A 81 C0                    ..
        cpx     #$F0                            ; F73C E0 F0                    ..
        sed                                     ; F73E F8                       .
        .byte   $FC                             ; F73F FC                       .
        .byte   $FE                             ; F740 FE                       .
LF741:  .byte   $FF                             ; F741 FF                       .
        .byte   $FF                             ; F742 FF                       .
        .byte   $FF                             ; F743 FF                       .
        .byte   $7F                             ; F744 7F                       .
        .byte   $3F                             ; F745 3F                       ?
...
LF794:  jsr     LF8B6                           ; F794 20 B6 F8                  ..
        ...
        bit     $F9                             ; F79C 24 F9                    $.
        bvc     LF7A9                           ; F79E 50 09                    P.
LF7A0:  jsr     LF8AA                           ; F7A0 20 AA F8                  ..
        dex                                     ; F7A3 CA                       .
        bne     LF7A0                           ; F7A4 D0 FA                    ..
LF7A6:  jmp     LF813                           ; F7A6 4C 13 F8                 L..

; ----------------------------------------------------------------------------
LF7A9:  jsr     LF8B0                           ; F7A9 20 B0 F8                  ..
        dex                                     ; F7AC CA                       .
        cld                                     ; F7AD D8                       .
        .byte   $FA                             ; F7AE FA                       .
...
LF822:  bvc     LF82A                           ; F822 50 06                    P.
        jsr     LF8AA                           ; F824 20 AA F8                  ..
        jmp     LF810                           ; F827 4C 10 F8                 L..

; ----------------------------------------------------------------------------
LF82A:  jsr     LF8B0                           ; F82A 20 B0 F8                  ..
...
LF85B:  ldy     $FD                             ; F85B A4 FD                    ..
        ...
        cpy     #$08                            ; F85E C0 08                    ..
        sty     $FD                             ; F860 84 FD                    ..
        bmi     LF86E                           ; F862 30 0A                    0.
        ldy     #$00                            ; F864 A0 00                    ..
        sty     $FD                             ; F866 84 FD                    ..
        inc     $FB                             ; F868 E6 FB                    ..
        bne     LF86E                           ; F86A D0 02                    ..
        inc     $FC                             ; F86C E6 FC                    ..
LF86E:  rts                                     ; F86E 60                       `

; ----------------------------------------------------------------------------
LF86F:  lda     $FB                             ; F86F A5 FB                    ..
        sec                                     ; F871 38                       8
        sbc     #$28                            ; F872 E9 28                    .(
        sta     $FB                             ; F874 85 FB                    ..
        bcs     LF87A                           ; F876 B0 02                    ..
        dec     $FC                             ; F878 C6 FC                    ..
LF87A:  rts                                     ; F87A 60                       `

; ----------------------------------------------------------------------------
LF87B:  lda     $FB                             ; F87B A5 FB                    ..
        clc                                     ; F87D 18                       .
        adc     #$28                            ; F87E 69 28                    i(
        sta     $FB                             ; F880 85 FB                    ..
        bcc     LF886                           ; F882 90 02                    ..
        inc     $FC                             ; F884 E6 FC                    ..
LF886:  rts                                     ; F886 60                       `
...
LF88A:  ldy     $FD                             ; F88A A4 FD                    ..
        lda     LF8A2,y                         ; F88C B9 A2 F8                 ...
        ldy     #$00                            ; F88F A0 00                    ..
        bit     $FA                             ; F891 24 FA                    $.
        bvc     LF89B                           ; F893 50 06                    P.
        ora     ($FB),y                         ; F895 11 FB                    ..
        sta     ($FB),y                         ; F897 91 FB                    ..
        clc                                     ; F899 18                       .
        rts                                     ; F89A 60                       `
...
; ----------------------------------------------------------------------------
LF89B:  eor     #$FF                            ; F89B 49 FF                    I.
        and     ($FB),y                         ; F89D 31 FB                    1.
        sta     ($FB),y                         ; F89F 91 FB                    ..
        rts                                     ; F8A1 60                       `

; ----------------------------------------------------------------------------
LF8A2:  .byte   $80                             ; F8A2 80                       .
        rti                                     ; F8A3 40                       @

; ----------------------------------------------------------------------------
        jsr     L0810                           ; F8A4 20 10 08                  ..
        .byte   $04                             ; F8A7 04                       .
        .byte   $02                             ; F8A8 02                       .
        .byte   $01                             ; F8A9 01                       .
LF8AA:  jsr     LF86F                           ; F8AA 20 6F F8                  o.
        jmp     LF88A                           ; F8AD 4C 8A F8                 L..

; ----------------------------------------------------------------------------
LF8B0:  jsr     LF87B                           ; F8B0 20 7B F8                  {.
...
; ----------------------------------------------------------------------------
LF956:  ldx     $1633                           ; F956 AE 33 16                 .3.
        lda     #$00                            ; F959 A9 00                    ..
        sta     $FB                             ; F95B 85 FB                    ..
        ldy     $1632                           ; F95D AC 32 16                 .2.
LF960:  stx     $FC                             ; F960 86 FC                    ..
LF962:  dey                                     ; F962 88                       .
        sta     ($FB),y                         ; F963 91 FB                    ..
        bne     LF962                           ; F965 D0 FB                    ..
        dex                                     ; F967 CA                       .
        cpx     #$A0                            ; F968 E0 A0                    ..
        bcs     LF960                           ; F96A B0 F4                    ..
        rts                                     ; F96C 60                       `
...
LF976:  ror     $FA                             ; F976 66 FA                    f.
        ...
        sty     $BF4A                           ; F97D 8C 4A BF                 .J.
        jsr     LF8D6                           ; F980 20 D6 F8                  ..
        jsr     LF88A                           ; F983 20 8A F8                  ..
        ldy     $BF4A                           ; F986 AC 4A BF                 .J.
        rts                                     ; F989 60                       `

; ----------------------------------------------------------------------------
        pha                                     ; F98A 48                       H
        lda     $1703                           ; F98B AD 03 17                 ...
        ora     #$03                            ; F98E 09 03                    ..
        sta     $1703                           ; F990 8D 03 17                 ...
        lda     $1702                           ; F993 AD 02 17                 ...
        and     #$FC                            ; F996 29 FC                    ).
        ora     #$02                            ; F998 09 02                    ..
        sta     $1702                           ; F99A 8D 02 17                 ...
        lda     $1703                           ; F99D AD 03 17                 ...
        and     #$FC                            ; F9A0 29 FC                    ).
        sta     $1703                           ; F9A2 8D 03 17                 ...
        pla                                     ; F9A5 68                       h
        rts                                     ; F9A6 60                       `

; ----------------------------------------------------------------------------
        jsr     LF9C1                           ; F9A7 20 C1 F9                  ..
        stx     $BF4D                           ; F9AA 8E 4D BF                 .M.
...
LF9C1:  lda     #$16                            ; F9C1 A9 16                    ..
        ...
        jsr     LF39D                           ; F9CD 20 9D F3                  ..
        bne     LF9D5                           ; F9D0 D0 03                    ..
        jmp     (L1612)                         ; F9D2 6C 12 16                 l..

; ----------------------------------------------------------------------------
LF9D5:  cmp     #$52                            ; F9D5 C9 52                    .R
        beq     LF9E4                           ; F9D7 F0 0B                    ..
        cmp     #$57                            ; F9D9 C9 57                    .W
        beq     LF9EC                           ; F9DB F0 0F                    ..
...
; ----------------------------------------------------------------------------
LF9E4:  iny                                     ; F9E4 C8                       .
        jsr     LFA31                           ; F9E5 20 31 FA                  1.
        sta     $1654,x                         ; F9E8 9D 54 16                 .T.
        rts                                     ; F9EB 60                       `

; ----------------------------------------------------------------------------
LF9EC:  iny                                     ; F9EC C8                       .
        stx     $BF4D                           ; F9ED 8E 4D BF                 .M.
        jsr     LFAEE                           ; F9F0 20 EE FA                  ..
        ldx     $BF4D                           ; F9F3 AE 4D BF                 .M.
        lda     $DF                             ; F9F6 A5 DF                    ..
...
; ----------------------------------------------------------------------------
LFA31:  jsr     LF39D                           ; FA31 20 9D F3                  ..
        stx     $BF4D                           ; FA34 8E 4D BF                 .M.
        ldx     #$04                            ; FA37 A2 04                    ..
LFA39:  cmp     LFA4D,x                         ; FA39 DD 4D FA                 .M.
        beq     LFA44                           ; FA3C F0 06                    ..
        dex                                     ; FA3E CA                       .
        bpl     LFA39                           ; FA3F 10 F8                    ..
...
LFA44:  txa                                     ; FA44 8A                       .
        ...
        ldx     $BF4D                           ; FA48 AE 4D BF                 .M.
        iny                                     ; FA4B C8                       .
        rts                                     ; FA4C 60                       `

; ----------------------------------------------------------------------------
LFA4D:  lsr     $53                             ; FA4D 46 53                    FS
        eor     $4158,y                         ; FA4F 59 58 41                 YXA
...
; ----------------------------------------------------------------------------
LFAEE:  ldx     #$DF                            ; FAEE A2 DF                    ..
LFAF0:  bne     LFAF4                           ; FAF0 D0 02                    ..
...
LFB11:  ldx     #$E5                            ; FB11 A2 E5                    ..
        jsr     LF39D                           ; FB13 20 9D F3                  ..
...
LFB2A:  pla                                     ; FB2A 68                       h
        tax                                     ; FB2B AA                       .
        jmp     LF3A8                           ; FB2C 4C A8 F3                 L..

; ----------------------------------------------------------------------------
LFB2F:  jsr     LF39C                           ; FB2F 20 9C F3                  ..
LFB32:  iny                                     ; FB32 C8                       .
...
RESET:  cld                                     ; FC00 D8                       .
        ...
        txs                                     ; FC03 9A                       .
        lda     #$00                            ; FC04 A9 00                    ..
        sta     $1701                           ; FC06 8D 01 17                 ...
        lda     $1700                           ; FC09 AD 00 17                 ...
        bpl     LFC14                           ; FC0C 10 06                    ..
        asl     a                               ; FC0E 0A                       .
        sta     $0F                             ; FC0F 85 0F                    ..
LFC11:  jmp     LFC9B                           ; FC11 4C 9B FC                 L..

; ----------------------------------------------------------------------------
LFC14:  asl     a                               ; FC14 0A                       .
LFC15:  .byte   $10                             ; FC15 10                       .
LFC16:  .byte   $03                             ; FC16 03                       .
        jmp     L1C22                           ; FC17 4C 22 1C                 L".
...
; ----------------------------------------------------------------------------
        ...
        txs                                     ; FC1E 9A                       .
        lda     #$00                            ; FC1F A9 00                    ..
        sta     $1583                           ; FC21 8D 83 15                 ...
        lda     $158C                           ; FC24 AD 8C 15                 ...
        and     #$F0                            ; FC27 29 F0                    ).
        ora     $0E                             ; FC29 05 0E                    ..
        sta     $158C                           ; FC2B 8D 8C 15                 ...
LFC2E:  jsr     LFC7F                           ; FC2E 20 7F FC                  ..
        cmp     #$58                            ; FC31 C9 58                    .X
        bne     LFC2E                           ; FC33 D0 F9                    ..
        jsr     LFC7F                           ; FC35 20 7F FC                  ..
        jsr     LFC7F                           ; FC38 20 7F FC                  ..
LFC3B:  jsr     LFC7F                           ; FC3B 20 7F FC                  ..
        jsr     LFC7F                           ; FC3E 20 7F FC                  ..
        sta     L0004                           ; FC41 85 04                    ..
        jsr     LFC7F                           ; FC43 20 7F FC                  ..
        sta     $05                             ; FC46 85 05                    ..
        jsr     LFC7F                           ; FC48 20 7F FC                  ..
        sta     $00                             ; FC4B 85 00                    ..
        jsr     LFC7F                           ; FC4D 20 7F FC                  ..
        sta     $01                             ; FC50 85 01                    ..
        jsr     LFC7F                           ; FC52 20 7F FC                  ..
        sta     $02                             ; FC55 85 02                    ..
        jsr     LFC7F                           ; FC57 20 7F FC                  ..
        sta     $03                             ; FC5A 85 03                    ..
        ldx     #$00                            ; FC5C A2 00                    ..
        txa                                     ; FC5E 8A                       .
LFC5F:  sec                                     ; FC5F 38                       8
...
; ----------------------------------------------------------------------------
LFC7F:  lda     $158D                           ; FC7F AD 8D 15                 ...
        and     #$02                            ; FC82 29 02                    ).
        beq     LFC7F                           ; FC84 F0 F9                    ..
        lda     $1581                           ; FC86 AD 81 15                 ...
        pha                                     ; FC89 48                       H
        lda     $158C                           ; FC8A AD 8C 15                 ...
        and     #$F0                            ; FC8D 29 F0                    ).
        ora     #$0C                            ; FC8F 09 0C                    ..
        sta     $158C                           ; FC91 8D 8C 15                 ...
        ora     #$0E                            ; FC94 09 0E                    ..
        sta     $158C                           ; FC96 8D 8C 15                 ...
        pla                                     ; FC99 68                       h
        rts                                     ; FC9A 60                       `
...
LFC9B:  cld                                     ; FC9B D8                       .
        ...
        sei                                     ; FC9F 78                       x
        lda     #$00                            ; FCA0 A9 00                    ..
        sta     $1580                           ; FCA2 8D 80 15                 ...
        sta     $158E                           ; FCA5 8D 8E 15                 ...
        sta     $1583                           ; FCA8 8D 83 15                 ...
        lda     #$EE                            ; FCAB A9 EE                    ..
        sta     $158C                           ; FCAD 8D 8C 15                 ...
        lda     #$FF                            ; FCB0 A9 FF                    ..
        sta     $1582                           ; FCB2 8D 82 15                 ...
        lda     #$00                            ; FCB5 A9 00                    ..
        sta     $06                             ; FCB7 85 06                    ..
        sta     $08                             ; FCB9 85 08                    ..
        lda     #$20                            ; FCBB A9 20                    . 
        ...
        stx     $0D                             ; FCC5 86 0D                    ..
        stx     $0E                             ; FCC7 86 0E                    ..
        jsr     LFD9B                           ; FCC9 20 9B FD                  ..
        bcs     LFCEB                           ; FCCC B0 1D                    ..
        bit     $0F                             ; FCCE 24 0F                    $.
...
LFCEA:  .byte   $20                             ; FCEA 20                        
LFCEB:  jmp     L4CFD                           ; FCEB 4C FD 4C                 L.L
...
LFD13:  lda     $0A                             ; FD13 A5 0A                    ..
        cmp     $08                             ; FD15 C5 08                    ..
        bne     LFD25                           ; FD17 D0 0C                    ..
        lda     $0B                             ; FD19 A5 0B                    ..
        cmp     $09                             ; FD1B C5 09                    ..
        bne     LFD25                           ; FD1D D0 06                    ..
...
LFD4C:  bit     $0F                             ; FD4C 24 0F                    $.
        ...
        bcs     LFD9A                           ; FD59 B0 3F                    .?
        dec     $0D                             ; FD5B C6 0D                    ..
        jmp     LFD9B                           ; FD5D 4C 9B FD                 L..
...
LFD87:  php                                     ; FD87 08                       .
        cmp     #$00                            ; FD88 C9 00                    ..
        bne     LFD9A                           ; FD8A D0 0E                    ..
        lda     $09                             ; FD8C A5 09                    ..
        cmp     #$80                            ; FD8E C9 80                    ..
        bne     LFD9A                           ; FD90 D0 08                    ..
        lda     #$00                            ; FD92 A9 00                    ..
        sta     $08                             ; FD94 85 08                    ..
        lda     #$20                            ; FD96 A9 20                    . 
        sta     $09                             ; FD98 85 09                    ..
...
; ----------------------------------------------------------------------------
LFD9B:  lda     $158D                           ; FD9B AD 8D 15                 ...
        sec                                     ; FD9E 38                       8
        and     #$02                            ; FD9F 29 02                    ).
        beq     LFDB8                           ; FDA1 F0 15                    ..
        lda     $1581                           ; FDA3 AD 81 15                 ...
        pha                                     ; FDA6 48                       H
        lda     $158C                           ; FDA7 AD 8C 15                 ...
        and     #$F0                            ; FDAA 29 F0                    ).
        ora     #$0C                            ; FDAC 09 0C                    ..
        sta     $158C                           ; FDAE 8D 8C 15                 ...
        ora     #$0E                            ; FDB1 09 0E                    ..
        sta     $158C                           ; FDB3 8D 8C 15                 ...
        pla                                     ; FDB6 68                       h
        clc                                     ; FDB7 18                       .
LFDB8:  rts                                     ; FDB8 60                       `
...
LFDB9:  pha                                     ; FDB9 48                       H
        ...
        sta     $1580                           ; FDBF 8D 80 15                 ...
        lda     $158C                           ; FDC2 AD 8C 15                 ...
        and     #$0F                            ; FDC5 29 0F                    ).
        ora     #$C0                            ; FDC7 09 C0                    ..
        sta     $158C                           ; FDC9 8D 8C 15                 ...
        ora     #$E0                            ; FDCC 09 E0                    ..
        sta     $158C                           ; FDCE 8D 8C 15                 ...
        sec                                     ; FDD1 38                       8
        ror     $0E                             ; FDD2 66 0E                    f.
        clc                                     ; FDD4 18                       .
LFDD5:  lda     $158D                           ; FDD5 AD 8D 15                 ...
        and     #$11                            ; FDD8 29 11                    ).
